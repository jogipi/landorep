...
My Theme boasts a clean HTML5 structure with extensible CSS classes and IDs for
...
My Theme's goal is to provide themers the building blocks needed to get their
designs up and running quickly and simply.

My Theme is perfect if you want a simple, smart, and flexible theme starter.
...
My Theme utilizes SASS for adaptive grids and layouts and general structure of the
...
My Theme is meant to be YOUR theme. Follow one of the two methods below and you can
rename 'my_theme' to another name like 'mytheme'. You're also welcome to keep
'my_theme'.

1. DRUSH: The provided drush install script will duplicate the my_theme theme
   folder and rename all appropriate files and content to the new theme name you
   provide.

  - Download and enable the my_theme theme: $ drush en my_theme
  - Set the theme as default $ drush config-set system.theme default my_theme
    or copy the includes/my_theme.drush.inc into your .drush folder.
  - Run the provided drush install script: $ drush my_theme-install
  ...
  - At this time, you can uninstall my_theme: $drush pmu my_theme
...
2. MANUAL: To manually change the name of the theme follow these steps BEFORE
  ...
  - Rename my_theme.info.yml to mytheme.info.yml
  - edit my_theme.info.yml and change the name, description, project (can be
    deleted), and change all other instances of 'my_theme' to 'mytheme'
  - Rename my_theme.libraries.yml to mytheme.libraries.yml
  - Rename my_theme.theme to mytheme.theme
  - in my_theme.theme, change each instance of 'my_theme' to 'mytheme'
  - Rename config/schema/my_theme.schema.yml to mytheme.schema.yml
  - Rename each file in config/install from block.block.my_theme_tools.yml (for
    example) to block.block.mytheme_tools.yml
  - Every file in config/install, change each instance of 'my_theme' to
    'mytheme'
  - In js/source/scripts.js, change each instance of 'my_theme' to 'mytheme'
  - In theme-settings.php, change each instance of 'my_theme' to 'mytheme'
  - In templates/html.html.twig, change each instance of 'my_theme' to 'mytheme'
  - In templates/menu-local-tasks.html.twig, change each instance of 'my_theme' to
    'mytheme'
  - In templates/status-messages.html.twig, change each instance of 'my_theme' to
    'mytheme'

  When renaming, remember the following:
  - Do not simply replace every instance of 'my_theme' in every file in the theme.
    Most of My Theme's dependencies use the word 'my_theme' somewhere and renaming
    these instances will cause My Theme to break in unpredictable ways.
  ...
  - If you don't bother renaming My Theme in the above locations, be advised that
    you will run into conflicts with other versions of My Theme on your site. If
    your site uses more than one theme based on My Theme, make sure at least one of
    the themes has been renamed properly!


============================
How to compile SASS in My Theme
============================

To use SASS and automatically compile it within your theme, please refer to "How
to Use Grunt with My Theme" in the documentation below.
...
- build/scripts.js & source/scripts.js
  ...
  folder. See comments in my_theme.libraries.yml file to enable the starter
  scripts.js file.
...
The layout used in My Theme is fairly similar to the Holy Grail method. It has been
...
This is how the page template is buit in My Theme, and it works in fluid and fixed
layout. Refer to the notes in layout.sass to see how to modify the layout.


===========================
How to Use Grunt with My Theme
===========================
...
Once Node.JS is installed, go to the root folder of My Theme and install your Grunt
packages:
...
Once installed, cd to the root folder of My Theme and run Grunt via the command
line:
...
Once you start using My Theme, you will massively change it until you reach the
point where it has nothing to do with My Theme anymore. Unlike Zen, My Theme is not
...
version of My Theme comes out. Always see My Theme as a STARTER, and as soon as you
start using it, it is not My Theme anymore, but your own theme.

If you didn't rename your theme, but you don't want to be notified when My Theme
has a new version by the update module, simply delete "project = "my_theme" in
my_theme.info.yml.
...
Thanks for using My Theme, and remember to use the issue queue in drupal.org for
any questions or bug reports:

http://drupal.org/project/issues/my_theme
